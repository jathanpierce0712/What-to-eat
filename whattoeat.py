...
chinese_food = ["House of China", "Royal Grill", "Golden Hunan", "Main Moon", "Chinatown Inn"]
japanese_food = ["A1 steakhouse", "Mizu"]
mexican_food = ["Jalisco", "Chipolte", "Plaza Mexico"]
indian_food =["Cafe Indian", "Zenobia Cuisine and Bar", "Nick & Mintu da dhaba"]
pizza_food =["Pizza hut", "East of Chicago", "Papa Johns"]
fast_food = ["Chic Fil A", "Mcdonalds", "Arbys"]
italian_food = ["Olive Garden", "Marino's Italian Cafe", "Belleria Pizza & Italian"]
